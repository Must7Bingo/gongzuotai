...
contextBridge.exposeInMainWorld('notchAPI', {
  ...
  translateText: (payload) => ipcRenderer.invoke('tools:translate', payload),
  getTranslationStatus: () => ipcRenderer.invoke('tools:translation-status'),
  ...
  saveScreenRecording: (payload) => ipcRenderer.invoke('screen-recordings:save', payload),
  readScreenRecording: (videoPath) => ipcRenderer.invoke('screen-recordings:read', videoPath),
  deleteScreenRecording: (videoPath) => ipcRenderer.invoke('screen-recordings:delete', videoPath),
  revealScreenRecording: (videoPath) => ipcRenderer.invoke('screen-recordings:reveal', videoPath),
